...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Alvino Revaldi"; //nama
  final String npm = "2406438933"; //npm
  ...
  final List<ItemHomepage> items = [
    ...
    ItemHomepage("Logout", Icons.logout, Colors.deepOrangeAccent)
  ];
